...
[![NPM Downloads](https://img.shields.io/npm/dt/@malang-dev/oauth2-server?label=npm%20downloads&style=flat-square)](https://www.npmjs.com/package/@malang-dev/oauth2-server)
...
Choose your preferred package manager to install @malang-dev/oauth2-server:
...
```ts
import { requestFromExpress } from "@malang-dev/oauth2-server/express";
